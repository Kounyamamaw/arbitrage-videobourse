      ...
      <div className="flex items-center gap-2 mb-2">
        <button
          ...
          style={{
            ...
            borderColor: activeCount > 0 ? "var(--accent-mid)" : "var(--border)",
        ...
        >
          ...
          {activeCount > 0 && (
            <span style={{
              ...
              borderRadius: 100, backgroundColor: "var(--accent)", color: "#fff",
            }}>
              {activeCount}
            </span>
          )}
        ...
        {activeCount > 0 && (
          <button
            onClick={reset}
            style={{ fontSize: 11, color: "var(--text-faint)", background: "none", border: "none", cursor: "pointer", padding: "4px 8px" }}
          >
            Réinit.
          </button>
        )}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            {activeCount > 0 && (
              <span style={{ fontSize: 10, fontWeight: 700, padding: "1px 7px", borderRadius: 100, backgroundColor: "var(--accent)", color: "#fff" }}>{activeCount}</span>
            )}
          </div>
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            {activeCount > 0 && (
              <button onClick={reset} style={{ fontSize: 11, color: "var(--text-faint)", background: "none", border: "none", cursor: "pointer" }}>Réinit.</button>
            )}
            <button
              onClick={() => setOpen(false)}
            ...
            {showAdvanced && (
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                    {FISCALITIES.map((fi) => <FilterBtn key={fi.value} active={fiscality === fi.value} label={fi.label} onClick={() => setFiscality(fi.value)} />)}
                  </div>
                </div>
                <div>
